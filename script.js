...
const sampleData = [
  {
    ...
    proposito_sueno:
      "Empoderar a mujeres para que descubran su poder personal, construyan libertad financiera desde el mundo digital y se atrevan a vivir una vida que se sienta libre, coherente y suya.",
    motivacion:
      "Ver a más mujeres apostando por ellas mismas, creando libertad con lo que aman y demostrando que sí pueden. Me mueve saber que no tienen que hacerlo solas, y que yo puedo ser parte de ese impulso.",
    red_social: "https://www.instagram.com/_andreacazarin",
    mensaje:
      "Que no están solas. Que este espacio es para crecer, equivocarnos, levantarnos y lograrlo juntas. Aquí hay apoyo real, impulso y herramientas para que construyas tu camino con propósito y poder.",
...
class ModalManager {
  ...
  openModal(person) {
    ...
    document.getElementById("modal-location").textContent = person.city_country;
    document.getElementById("modal-profession").textContent = person.carrer;
    document.getElementById("modal-purpose").textContent = person.goal;
    document.getElementById("modal-motivation").textContent = person.motivation;
    document.getElementById("modal-message").textContent = person.message;

    // Configurar foto
    const modalPhoto = document.getElementById("modal-photo");
    modalPhoto.src = person.profileImage;
    modalPhoto.alt = person.name;

    // Configurar enlace social
    const socialLink = document.getElementById("modal-social-link");
    socialLink.href = person.socialNetwork;
